...
{
	brickFile = "Add-Ons/Brick_ModTer_BasicPack/Bricks/Steep/8cSteep.blb";
	category = "ModTer";
	subCategory = "8x";
	uiName = "8x Cube Steep";
	iconName = "Add-Ons/Brick_ModTer_BasicPack/BrickIcons/Steep/8cSteep";
	CollisionShapeName = "Add-Ons/Brick_ModTer_BasicPack/Shapes/Steep/8cSteepCol.dts";
        hasPrint = 1;
	printAspectRatio = "ModTer";
	isWaterBrick = true;
};
